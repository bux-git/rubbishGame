...
import com.common.widget.avplayer.base.BSPlayer;
import com.common.widget.avplayer.cover.GestureCover;
import com.common.widget.avplayer.utils.PUtil;
...
public class ListPlayer extends BSPlayer {
    ...
    protected RelationAssist onCreateRelationAssist() {
        RelationAssist assist = new RelationAssist(MyApplication.get());
        assist.setAspectRatio(AspectRatio.AspectRatio_16_9);
